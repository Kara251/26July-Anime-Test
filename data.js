var TC2SC = '這这開开點点問问題题測测驗验動动畫画過过電电腦脑書书對对體体節节選选愛爱關关鍵键詞词類类該该經经極极轉转話话與与機机覺觉歡欢間间線线實实結结單单見见風风來来個个從从現现義义門门當当場场鄉乡飛飞國国園园熱热鬧闹隊队計计協协調调負负觀观樣样麼么發发屬属進进壓压龍龙劍剑闊阔滿满競竞夢梦灑洒揮挥淚泪複复華华壯壮無无雲云戀恋綿绵餘余暉晖紛纷陣阵腎肾飆飙據据準准領领雞鸡裡里後后號号報报穩稳歷历歲岁約约讓让療疗癒愈歎叹盡尽僅仅幣币優优歸归臉脸頭头輯辑斷断豐丰積积際际訊讯職职藝艺總总輕轻雜杂沒没帶带險险廳厅東东搖摇滾滚懸悬詩诗響响樂乐暫暂讀读謎谜傳传說说運运賽赛遊游戲戏聞闻聰聪祕秘異异靜静員员櫻樱鎮镇閃闪爍烁飄飘衝冲鋒锋擬拟筆笔棄弃堅坚強强萬万細细陰阴邏逻圍围騰腾燒烧觸触層层團团圓圆達达遺遗遠远邊边緊紧剝剥純纯戰战鬥斗鬆松寧宁僅仅顯显盤盘驅驱廢废歲岁獲获網网絡络醬酱繪绘織织續续練练時时為为備备佈布敘叙劇剧較较們们溫温氣气潤润劑剂賞赏變变膩腻嚮向係系議议設设穎颖討讨趨趋勢势內内規规尋寻標标復复寫写幾几';
  ...
  questions: [
    {
      ...
      options: [
        ...
        { text: "打開電腦，研究最近著迷的東西", scores: { mystery: 2, scifi: 1 } },
