var TC2SC = '這这開开點点問问題题測测驗验動动畫画過过電电腦脑書书對对體体節节選选愛爱關关鍵键詞词類类該该經经極极轉转話话與与機机覺觉歡欢間间線线實实結结單单見见風风來来個个從从現现義义門门當当場场鄉乡飛飞國国園园熱热鬧闹隊队計计協协調调負负觀观樣样麼么發发屬属進进壓压龍龙劍剑闊阔滿满競竞夢梦灑洒揮挥淚泪複复華华壯壮無无雲云戀恋綿绵餘余暉晖紛纷陣阵腎肾飆飙據据準准領领雞鸡裡里後后號号報报穩稳歷历歲岁約约讓让療疗癒愈歎叹盡尽僅仅幣币優优歸归臉脸頭头輯辑斷断豐丰積积際际訊讯職职藝艺總总輕轻雜杂';
...
var QUIZ_DATA = {
  ...
  results: {
    ...
    scifi: {
      ...
      animeRomaji: "PLACEHOLDER TITLE",
      typeName: "科幻未來型",
      description: "你對未來充滿想像，著迷於科技與人類的關係。這個夏天，你需要一部讓你重新思考現實邊界的作品。",
